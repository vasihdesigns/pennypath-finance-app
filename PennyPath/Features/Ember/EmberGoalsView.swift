//
//  EmberGoalsView.swift
//  PennyPath
//
//  Ember's Goals screen on real data: how far you are across everything you're
//  saving toward, then each goal as a card with a bronze bar that fills as you
...
struct EmberGoalsView: View {
    ...
    private let done = Color.adaptive(light: 0x2E7D5B, dark: 0x6FD3A6)
    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 16) {
                EmberHeader(title: "Goals") { showingSettings = true }
    ...
    private var summaryCard: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            EmberMeter(value: overallProgress, tint: Ember.accentSoft)
            if completedCount > 0 {
    ...
    private func goalCard(_ goal: Goal) -> some View {
        let tint = goal.isComplete ? done : Ember.accentSoft
        return VStack(alignment: .leading, spacing: 10) {
            ...
            EmberMeter(value: goal.progress, tint: tint)
            HStack {
    ...
    private var emptyCard: some View {
        VStack(spacing: 14) {
            ...
            Text("Set your first goal")
                ...
                .foregroundStyle(Ember.onCanvas)
            Text("Pick something you'd love to save for — a bike, a trip, a rainy-day fund — and watch the bronze bar fill up.")
                .font(.system(size: 14))
                .foregroundStyle(Ember.onCanvasSoft)
...
/// A thin progress meter in the Ember palette.
struct EmberMeter: View {
    var value: Double                  // 0…1
    var tint: Color = Ember.accentSoft
